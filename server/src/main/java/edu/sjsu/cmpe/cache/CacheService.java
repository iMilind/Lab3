...
public class CacheService extends Service<CacheServiceConfiguration> {
    ...
    public static final String PATH_OF_FILE="/tmp/";
private static String FILE_NAME="";
    public static void main(String[] args) throws Exception {
    	FILE_NAME=args[1].substring(7, 15)+"_LOG.txt";
 ...
 String path_file=PATH_OF_FILE+getFileName();
 File fi=new File(path_file);
